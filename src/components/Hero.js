...
const Hero = () => {
  return (
    <div class="flex flex-wrap md items-center h-screen">
      <div class="bg-white w-full md:w-1/2 h-screen">
        <div class="mx-32">
          ...
          <div class="description w-full sm: md:w-2/3 mt-16 text-gray-500 text-sm">
            ...
            classics to cutting-edge series. Whether you&apos;re a
            binge-watcher, a die-hard fan, or just seeking your next obsession,
            we&apos;ve got you covered. Explore, discuss, and stay tuned for all
            things TV!&apos;
          </div>
      ...
      <div class=" w-full md:w-1/2 h-screen bg-[url('/assets/dc1.png')]"></div>
    </div>
  );
};
